        ...
        <div className="space-y-4">
          <div className="rounded-2xl border border-white/10 bg-black/20 p-4">
            ...
            <div className="grid sm:grid-cols-2 gap-3">
              <div className="grid sm:grid-cols-2 gap-3 mt-3">
                <KVCompact label={t.contMono} value={res ? `${fmt(res.I1)} A` : "—"} />
                <KVCompact label={t.contTri} value={res ? `${fmt(res.I3)} A/fase` : "—"} />
              </div>
            </div>
          </div>
          ...
          <div className="rounded-2xl border border-white/10 bg-black/20 p-4">
            ...
            <div className="grid sm:grid-cols-2 gap-3 mt-3">
              ...
              <KVHighlight
                label={t.genInterval}
                value={res ? `${fmt(res.kvaMusic)} → ${fmt(res.kvaTotal)} kVA` : "—"}
            ...
            {/* Menos destaque */}
            <div className="grid sm:grid-cols-2 gap-3 mt-3">
              <KVCompact label={t.genMax} value={res ? `${fmt(res.kvaTotal)} kVA` : "—"} />
              <KVCompact
                label={t.genRange}
              ...
              <div className="grid sm:grid-cols-2 gap-3 mt-3">
                <div className="rounded-xl border border-white/10 bg-black/30 p-3">
                  ...
                  <div className="mt-2 space-y-2">
                    <KVCompact label={t.instAvgCurrent} value={res ? `${fmt(res.I1Avg)} A` : "—"} />
                    <KVCompact label={t.instBreaker} value={res ? `${res.monoBreakerManual} A` : "—"} />
                    <KVCompact label={t.instCable} value={res ? `${res.monoCableAvg} mm²` : "—"} />
                  </div>
                </div>
                ...
                <div className="rounded-xl border border-white/10 bg-black/30 p-3">
                  ...
                  <div className="mt-2 space-y-2">
                    <KVCompact label={t.instAvgCurrent} value={res ? `${fmt(res.I3Avg)} A/fase` : "—"} />
                    <KVCompact label={t.instBreaker} value={res ? `${res.triBreakerManual} A` : "—"} />
                    <KVCompact label={t.instCable} value={res ? `${res.triCableAvg} mm²` : "—"} />
                  </div>
                </div>
              </div>
